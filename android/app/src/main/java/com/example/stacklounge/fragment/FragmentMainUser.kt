 ...
 * Use the [FragmentMainUser.newInstance] factory method to
...
class FragmentMainUser : Fragment() {
    ...
    override fun onCreateView(
        ...
        /*btnlogout.setOnClickListener {
            ...
            startActivity(
                Intent(getActivity(), LoginActivity::class.java)
            )
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentMainUser.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentMainUser().apply {
